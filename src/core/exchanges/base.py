#!/usr/bin/env python3
"""Core exchange primitives used across the Open Interest engine."""
...
class ExchangeFailure:
    """Structured metadata describing a failed exchange fetch."""
...
class ExchangeDataError(Exception):
    """Exception raised when an exchange cannot provide fresh data."""

    def __init__(self, exchange: str, reason: str, details: Optional[Dict[str, Any]] = None):
